...
import { User as UserIcon, Mail, Wallet, Save } from 'lucide-react';
  ...
  return (
    <div className="max-w-xl mx-auto space-y-6">
      ...
      <div className="glass-card p-6 text-center">
        <div className="w-24 h-24 bg-gradient-to-br from-[#6938ef] to-[#d534d8] rounded-full flex items-center justify-center text-3xl font-bold mx-auto mb-4">
